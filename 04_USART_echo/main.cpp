...
static void InitUart4(const uint32_t baudrate, const uint32_t irq_priority);
static void InitUart5(const uint32_t baudrate, const uint32_t irq_priority);
static void InitUsart6(const uint32_t baudrate, const uint32_t irq_priority);
static void InitUart7(const uint32_t baudrate, const uint32_t irq_priority);
static void InitUart8(const uint32_t baudrate, const uint32_t irq_priority);
...
int main() {
  ...
  InitUart4(UART4_BAUDRATE, UART4_IRQ_PRIORITY);
  InitUart5(UART5_BAUDRATE, UART5_IRQ_PRIORITY);
  InitUsart6(USART6_BAUDRATE, USART6_IRQ_PRIORITY);
  InitUart7(UART7_BAUDRATE, UART7_IRQ_PRIORITY);
  InitUart8(UART8_BAUDRATE, UART8_IRQ_PRIORITY);
